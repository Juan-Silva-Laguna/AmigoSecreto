...
<head>
    ...
    <style>
        ...
        .body--ready {
            background: -webkit-linear-gradient(top, rgb(205, 146, 235) 10%, rgb(167, 56, 114) 85%);
            background: -moz-linear-gradient(top, rgb(205, 146, 235) 0%, rgb(167, 56, 114) 120%);
            background: -o-linear-gradient(top, rgb(205, 146, 235) 0%, rgb(167, 56, 114) 120%);
            background: -ms-linear-gradient(top, rgb(205, 146, 235) 0%, rgb(167, 56, 114) 120%);
            background: linear-gradient(top, rgb(205, 146, 235) 0%, rgb(167, 56, 114) 120%);
        }
        ...
        .round-button {
            ...
            height: 50px;
            border-radius: 50%;
            background-color: #000; /* Cambia el color del botón según tus preferencias */
            border: none;
            cursor: pointer;
            position: fixed;
            top: 20px;
...
<body>
<div class="container">
        <button class="round-button" onclick="volver()">
            <span class="close-icon">X</span>
        </button>
        <button class="round-button2" onclick="contacto()">
            <i class="fa fa-whatsapp fa-lg"  data-toggle="tooltip" data-placement="top" title="Contacto de {{$usuarioOculto['nombre']}}"></i>
        </button>
    </div>
    <canvas class="canvas"></canvas>

    <div class="ui">
        <input class="ui-input" type="hidden" value="{{$usuarioOculto['nombre']}}"/>
            ...
            <div class="tabs-panels">
                <ul class="tabs-panel commands">
                    <li class="commands-item"><span class="commands-item-title">Text</span><span
                            class="commands-item-info" data-demo="Hello :)">Type anything</span><span
    ...
    <script>
            ...
            function performAction(value) {
                ...
                timedAction(function (index) {
                    ...
                    switch (action) {
                        ...
                        case 'cd':
                            var newtime = new Date('2018/02/28 20:18:00')
                            ...
                            if (t > 180) {
                                ...
                                timedAction(function () {
                                    ...
                                    if (t > 0) {
                                        ...
                                        t = parseInt(t / 1000)
                                        var diffHour = parseInt(t / 3600);
                                        t -= 3600 * diffHour;
                                        var diffMin = parseInt(t / 60);
                                        t -= 60 * diffMin;
                                        var diffSec = t;

                                        var word;

                                        if (diffHour == 0 && diffMin < 3) {
                                            word = diffMin + 'm ' + diffSec + 's'
                                        ...
                                        S.Shape.switchShape(S.ShapeBuilder.letter(word));
                                ...
                                timedAction(function () {
                                    ...
                                    if (t > 0) {
                                        ...
                                        if (diffSec == 0) {
                                            var s = "NYU Shanghai"
                                            S.Shape.switchShape(S.ShapeBuilder.letter(s));
                                        } else {
                                            S.Shape.switchShape(S.ShapeBuilder.letter(word));
                                        }
                                        console.log(diffHour, diffMin, diffSec);
        ...
        function contacto() {
            let ind = "{{$usuarioOculto['indicativo']}}";
            let num = "{{$usuarioOculto['whatsapp']}}";

            window.location.href = "https://wa.me/"+ind+num;
        }
    </script>
</body>
